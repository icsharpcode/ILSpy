...
- Added streaming and enhanced-context tests. AI-filtered `net10.0` tests pass **98/98**, and `dotnet build ILSpy.sln --no-restore` passes with 19 projects, 0 errors, and 0 warnings.
